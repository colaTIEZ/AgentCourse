...
public abstract class AbstractAgent implements Agent {
    ...
    private ChatClient. ChatClientRequestSpec getChatClientRequest(String question, String sessionId, String requestId) {
        return chatClient.prompt()
                .system(promptSystemSpec -> promptSystemSpec.text(systemMessage()).params(systemMessageParams()))
                .advisors(advisorSpec -> advisorSpec.advisors(advisors()).params(advisorParams(sessionId, requestId)))
                .tools(tools())
